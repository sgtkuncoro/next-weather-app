...
var _jsxFileName = "/Users/kunc/CodeLabs/next-weather-app/pages/_document.jsx";
...
function (_Document) {
  ...
  (0, _createClass2.default)(MyDocument, [{
    ...
    value: function render() {
      ...
      var envScript = "window.ENV = '".concat(process.env.WILD_ENV || "development", "';");
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", _document.default.getInitialProps(ctx));
